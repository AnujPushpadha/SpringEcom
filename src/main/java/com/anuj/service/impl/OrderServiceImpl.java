...
import com.anuj.domain.PaymentStatus;
...
//import com.anuj.service.OrderItemService;
...
//		shippAddress.setUser(user);
    ...
    public Order findOrderById(Long orderId) throws Exception {
        ...
        throw new Exception("order not exist with id " + orderId);
    }
    ...
    public Order cancelOrder(Long orderId, User user) throws Exception {
        ...
        if (user.getId() != order.getUser().getId()) {
            throw new Exception("you can't perform this action " + orderId);
        }
